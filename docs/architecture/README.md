...
- сімейний read model зі статусами виконання плану.
...
Authorization враховує роль у сім’ї та тип профілю. OWNER має повний доступ до власного й залежного профілю, read-only доступ до щоденника іншого зареєстрованого дорослого та не може змінювати його факти. MEMBER керує лише власним щоденником. Application administrator не має автоматичного доступу до цих даних.
...
- OWNER може читати щоденники членів власної сім’ї, але змінює факти лише власного або залежного профілю;
