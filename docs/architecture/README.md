...
- контрольовану міграцію можливостей прототипу без механічного перенесення технічного боргу;
...
## Запланована структура монорепозиторію
...
Пакет `contracts` створюється лише за наявності підтвердженого спільного використання транспортних контрактів. Доменна логіка не виноситься до спільного пакета без визначеного власника та практично обґрунтованої потреби.
