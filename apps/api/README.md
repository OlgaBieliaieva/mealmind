...
`localhost` і `127.0.0.1` є різними origins. Для локального запуску allowlist
має явно містити адресу, через яку відкрито кожен web-застосунок; стандартний
`.env.example` дозволяє обидва hostname для портів 3000 і 3001.
