...
export const REFERENCE_CONFIGS: Readonly<Record<ReferenceResource, ReferenceConfig>> = {
  ...
  authors: {
    ...
    fields: [
      ...
      { name: "instagramUrl", label: "Instagram", kind: "url", nullable: true },
      { name: "youtubeUrl", label: "YouTube", kind: "url", nullable: true },
      { name: "tiktokUrl", label: "TikTok", kind: "url", nullable: true },
      { name: "websiteUrl", label: "Вебсайт", kind: "url", nullable: true },
      { name: "otherUrl", label: "Інше посилання", kind: "url", nullable: true },
      active,
    ],
  },
  brands: {
