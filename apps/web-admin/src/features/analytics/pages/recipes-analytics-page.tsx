      ...
      <section aria-labelledby="recipe-creator-title">
        <div className="analytics-section-heading">
          <div>
            ...
            <p>
              Рецепти, створені звичайними користувачами, відображаються окремо. Записи без
              створювача або створені адміністратором належать до системних та імпортованих. Це не
              замінює доменного автора рецепта.
            </p>
          </div>
        </div>
        <BreakdownCard
